...
reg [31:0] regs[0:15]; //32 bit wide with a depth of 16 (for registers 0-15)
reg [31:0] read_data_1, read_data_2;

always@(posedge clk) begin
    if (rst == 0) begin
        if (write_to_reg_Flag == 1) begin
        ...
        {regs[0], regs[1], regs[2], regs[3], regs[4], regs[5], regs[6], regs[7], regs[8], regs[9], regs[10], regs[11], regs[12], regs[13], regs[14], regs[15]} <= 0; //sets all regs to 0
    end
